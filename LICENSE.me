      ...
      <div class="component">
        <h3 class="subtitle">notice to user:</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">1. DEFINITIONS</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">2. GENERAL USE</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">3. INTELLECTUAL PROPERTY RIGHTS</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">4. WARRANTY</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">5. LIMITATION OF LIABILITY</h3>
        <p class="txt">
        ...
        <h3 class="subtitle">6. NON-WAIVER</h3>
        <p class="txt">
